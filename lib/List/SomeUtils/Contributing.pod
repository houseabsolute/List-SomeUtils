...
List::SomeUtils::Contributing - Gives rough introduction into contributing to List::SomeUtils
...
To contribute to List::SomeUtils, one has to arrange with the current
...
L<Graham Knop's Makefile.PL#L82|https://github.com/haarg/List-SomeUtils/blob/dd877f963deead742fc90005636c72c6be9060fc/Makefile.PL#L82>
in L<PR#9|https://github.com/perl5-utils/List-SomeUtils/pull/9> a desirable
one.

=head2 Orientation Guide

List::SomeUtils configuration stage heavily depends on L<Config::AutoConf>
...
people with older toolchains to use List::SomeUtils out of the box (maybe
